...
#define CLAY_PACKED_ENUM(name) enum name : uint8_t
...
#define CLAY_PACKED_ENUM(name) __pragma(pack(push, 1)) enum name __pragma(pack(pop))
#else
#define CLAY_PACKED_ENUM(name) enum __attribute__((__packed__)) name
#endif
